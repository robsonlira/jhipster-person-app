...
class PersonResourceIT {
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).cpf(UPDATED_CPF).birthDate(UPDATED_BIRTH_DATE);
    ...
    void partialUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.cpf(UPDATED_CPF);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).cpf(UPDATED_CPF).birthDate(UPDATED_BIRTH_DATE);
